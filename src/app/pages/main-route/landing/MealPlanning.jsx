      ...
      <PageLayout>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8">Your week of healthy eating is just a few taps away. After signing up, you all have access to a personalized dashboard where you can:</p>
            ...
            <p className="text-gray-600 mt-8">Whether you are new to meal prep or a seasoned pro, the app adapts to your lifestyle.</p>
          </div>
