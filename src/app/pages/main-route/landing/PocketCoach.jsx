      ...
      <PageLayout>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8">The Koumanis Diet is more than a meal planner&mdash;it is your personal wellness companion, built on science and behavior.</p>
            ...
            <p className="text-gray-600 mt-8">Your goals are within reach&mdash;with a coach that fits in your pocket.</p>
          </div>
