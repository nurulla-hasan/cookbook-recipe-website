      ...
      <PageLayout>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8">Access a library of articles and guides from nutritionists and fitness coaches. Empower yourself with knowledge to make lasting changes.</p>
            ...
            <p className="text-gray-600 mt-8">Knowledge is power&mdash;especially when paired with smart nutrition and exercise.</p>
          </div>
