...
const EditRecipe = () => {
    ...
    useEffect(() => {
        // You would typically fetch the recipe data here based on the id
        // For now, we'll just log the id to the console
        ...
        <div className="space-y-8">
            <Card className="py-6">
                ...
                <CardContent className="space-y-6">
                    ...
                    <Button size="lg" className="w-full" onClick={handleSubmit}>Update Recipe</Button>
                </CardContent>
            </Card>
        </div>
    );
